'use strict';
import { genreListener } from '../genres/genreListener.js';
//import { myListAfterLogin } from '../js/search/myListAfterLogin.js';
import { myListAfterLogin } from '../search/myListAfterLogin.js';
...
export function animationDropList(event) {
