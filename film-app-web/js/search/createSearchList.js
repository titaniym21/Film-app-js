'use strict';
import { Bg } from '../classSearch/classBgForList.js';
import { BoxSearch } from '../classSearch/classBoxSearch.js';
import { PosterInBox } from '../classSearch/classPosterInBoxSearch.js';
import { TitleInBox } from '../classSearch/classTitleInBoxSearch.js';
import { ButtonCloseSearch } from '../classSearch/classButtonCloseSearch.js';
...
export function createSearchList(obj) {
    let bg = new Bg();
