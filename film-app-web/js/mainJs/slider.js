...
import {addSliderNextPage} from './addSliderNextPage.js';
...
import {checkSizeAttributes2} from './sizeWindow.js';
//const heckSizeAttributes2 = require('./sizeWindow').CheckSizeAttributes2;

export async function initSlider(prevBtn, nextBtn, element, obj, genreName, currIndex) {
  ...
  function showItem(index) {
    checkSizeAttributes2(items, index);
  }
